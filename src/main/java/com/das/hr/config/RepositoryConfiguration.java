...
@Configuration
@EnableJpaRepositories(basePackages = { "com.company.hr.db"})
@EnableTransactionManagement
public class RepositoryConfiguration {

    private static final String[] ENTITY_PACKAGES = {"com.company.hr.db"};
    ...
    private static final String PROPERTY_NAME_HIBERNATE_DIALECT = "spring.hibernate.dialect";
    private static final String PROPERTY_NAME_HIBERNATE_FORMAT_SQL = "spring.hibernate.format_sql";
    private static final String PROPERTY_NAME_HIBERNATE_HBM2DDL_AUTO = "spring.hibernate.hbm2ddl.auto";
    private static final String PROPERTY_NAME_HIBERNATE_NAMING_STRATEGY = "spring.hibernate.ejb.naming_strategy";
    private static final String PROPERTY_NAME_HIBERNATE_SHOW_SQL = "spring.hibernate.show_sql";
